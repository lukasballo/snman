...
def calculate_accessibility_for_statent_cell_r5(
    ...
    if not sum_accessibility_contributions:
        ...
        # scale to 100% if using a sample of destinations
        accessibility['accessibility'] = accessibility['accessibility'] / destinations_sample
        for mode in [MODE_CYCLING, MODE_PRIVATE_CARS, MODE_TRANSIT, MODE_FOOT]:
            accessibility[f'accessibility_{mode}'] = accessibility[f'accessibility_{mode}'] / destinations_sample
